...
def g_trial_solution(x, parameters):
    ...
    """
    return 1 + (x ** 2) * neural_network(parameters, x)
...
def implicit_euler(ode, tspan=np.array([0.0, 1.0]), y0=[1, 0], num_steps=10):
    """
...
if __name__ == '__main__':
    ...
    plt.xlabel('t')
    plt.ylabel('y(t)')
    plt.title('Approximated solutions to Example 3')
    plt.show()
